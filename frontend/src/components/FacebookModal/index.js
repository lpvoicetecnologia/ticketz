...
const Schema = Yup.object().shape({
    ...
    facebookUserToken: Yup.string().required("Page Access Token obrigatório"),
});

const FacebookModal = ({ open, onClose, whatsAppId }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth scroll="paper">
            <DialogTitle>
                {whatsAppId ? "Editar conexão Facebook Messenger" : "Nova conexão Facebook Messenger"}
            </DialogTitle>
            <Formik
                    ...
                    <Form>
                        <DialogContent dividers>
                            <Typography className={classes.hint}>
                                Configure o Facebook Messenger com Page ID e Page Access Token (Meta for Developers).
                            </Typography>
                            <Field
                                as={TextField}
                            ...
                            <Field
                                as={TextField}
                                label="Verify Token (Token de Verificação)"
                                name="tokenMeta"
                                fullWidth
                                variant="outlined"
                                margin="dense"
